...
--tables: prescriber, drug
SELECT generic_name, COUNT(generic_name) AS count_of_drug_prescribed
FROM prescription
...
ORDER BY count_of_drug_prescribed DESC
LIMIT 5;
--Top 5 prescribed drugs for Family Practice include: metformin HCL, albuterol sufate, levothyroxine sodium,
--potassium chloride, and diltiazem HCL.
...
ORDER BY count_of_drug_prescribed DESC
LIMIT 5;
--Top 5 prescribed drugs for Cardiology include: diltiazem HCL, potassium chloride, nitroglycerin, warfarin sodium, and digoxin.
